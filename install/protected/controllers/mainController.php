...
$query[] = "CREATE TABLE IF NOT EXISTS `form_item` (
  ...
  `jahanpay_au` varchar(255) DEFAULT NULL,
...
$query[] = "INSERT INTO `form_item` (`id`, `gateway_id`, `form_id`, `jahanpay_au`, `amount`, `ip`, `time`, `status`, `email`, `phone`, `name`, `msg`, `values`, `extra`) VALUES
(1, 1, 2, 'none', 5000, '::1', 1413916259, 2, 'programmer@jahanpay.com', '', 'رضا', 'ممنون از شما', '--\nنحوه آشنایی با سایت : گوگل \n', NULL);
";
