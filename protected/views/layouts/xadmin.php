...
<head>
  ...
  <link rel="stylesheet" type="text/css" href='<?php echo Yii::app()->request->baseUrl; ?>/images/hastishop_admin/style.css' media='all' />
...
<!--footer-->
<div id=footer>
کلیه حقوق این سیستم متعلق به  <a href='http://jahanpay.me/index.php?ref=<?php echo Yii::app()->createAbsoluteUrl(''); ?>'><b>شرکت جهان پی </b></a> میباشد . 
<br>
Programmed by <a href='http://reza.in' title='رضا شیخله'><b>Reza.IN</b></a>
