...
class FormItem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('jahanpay_au, ip, email, name, extra', 'length', 'max'=>255),
			array('amount, phone', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, gateway_id, form_id, jahanpay_au, amount, ip, time, status, email, phone, name, msg, values, extra', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('jahanpay_au',$this->jahanpay_au,true);
